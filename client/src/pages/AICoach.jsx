...
import { Sparkles, Brain, Search, Loader2, ArrowRight } from 'lucide-react'
...
export default function AICoach() {
  ...
  const { analysis, loading, analyze, generateBrief, explainTopic } = useAICoach()
    ...
    <div className="space-y-6">
      ...
      <Card className="border border-border-subtle bg-card">
        ...
        <CardContent className="p-6 space-y-6">
          ...
          {explainError && <p className="text-secondary text-semantic-red">{explainError}</p>}
