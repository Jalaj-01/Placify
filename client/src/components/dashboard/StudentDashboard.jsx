        ...
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3 shrink-0 flex-wrap">
            ...
            <button
              ...
              className="px-4 py-2.5 rounded-xl bg-gradient-to-r from-accent to-accent-light text-white text-xs font-extrabold hover:opacity-95 transition-all shadow-lg shadow-accent/30 flex items-center gap-2 border border-white/20 hover:scale-[1.02] active:scale-[0.98] cursor-pointer"
            >
